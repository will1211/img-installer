...
# DOWNLOAD_URL="https://github.com/will1211/img-installer/raw/refs/heads/master/immortalwrt-24.10.4-x86-generic-generic-squashfs-combined-efi.img.gz"
  DOWNLOAD_URL="https://github.com/will1211/AutoBuildImmortalWrt/releases/download/Autobuild-x86-64/immortalwrt-24.10.4-x86-64-generic-squashfs-combined-efi.img.gz"
